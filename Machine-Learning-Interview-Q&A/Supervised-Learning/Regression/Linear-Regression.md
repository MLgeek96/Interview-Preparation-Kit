Q1. Assume you need to generate a predictive model using multiple regression. Explain how you intend to validate this model.
...
Q2. What are the drawbacks of a linear model?
...
Q3. What are the assumptions required for linear regression? What if some of these assumptions are violated?
...
Q4. What is collinearity and what to do with it? How to remove multicollinearity?
...
Q5. How to check if the regression model fits the data well?
